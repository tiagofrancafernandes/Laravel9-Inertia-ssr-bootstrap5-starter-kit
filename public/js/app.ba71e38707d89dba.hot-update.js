...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    togglePermission: function togglePermission(event) {
      ...
      if (!toAdd) {
        this.form.selectedPermissions = this.form.selectedPermissions.filter(function (item) {
          return item != permissionName;
        });
      }
      console.log(toAdd, permissionName, this.form.selectedPermissions, JSON.stringify(this.form.selectedPermissions));
      return;
      if (!permissionName) {
        return;
      }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("edd9375f65363bbe")
/******/ })();
/******/ 
/******/ }
);