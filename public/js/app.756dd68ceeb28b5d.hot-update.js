...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    toggleEnableEditRoleName: function toggleEnableEditRoleName(event) {
      ...
      this.form = this.updateForm('role_name', 'alterado');
  ...
  setup: function setup(props) {
    ...
    var updateForm = function updateForm(key, value) {
      var newValues = {};
      newValues["".concat(key)] = value;
      form = (0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_1__.useForm)(_objectSpread(_objectSpread({}, form.data()), newValues));
    };
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("dc030403f40fa4ad")
/******/ })();
/******/ 
/******/ }
);