...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    toggleEnableEditRoleName: function toggleEnableEditRoleName(event) {
      var _event$target$dataset, _event$target, _this$form;
      var originalRoleName = (_event$target$dataset = event === null || event === void 0 || (_event$target = event.target) === null || _event$target === void 0 || (_event$target = _event$target.dataset) === null || _event$target === void 0 ? void 0 : _event$target.originalRoleName) !== null && _event$target$dataset !== void 0 ? _event$target$dataset : null;
      if (!originalRoleName) {
        return null;
      }
      console.log(this.enableEditRoleName, this.originalRoleName, event === null || event === void 0 ? void 0 : event.target, this === null || this === void 0 || (_this$form = this.form) === null || _this$form === void 0 ? void 0 : _this$form.role_name);

      // if (!enableEditRoleName.value) {
      //     form.role_name = originalRoleName;
      // }
    }
  },
  setup: function setup(props) {
    ...
    var originalRoleName = props.role_name;
    return {
      form: form,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1f8a44d438e50024")
/******/ })();
/******/ 
/******/ }
);