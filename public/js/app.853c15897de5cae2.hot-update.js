...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    toggleEnableEditRoleName: function toggleEnableEditRoleName(event) {
      ...
      this.form.transform(function (_form) {
  ...
  setup: function setup(props) {
    ...
    form = (0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_1__.useForm)(_objectSpread(_objectSpread({}, form.data()), {}, {
      id: props.role.id,
      role_name: 'props.role.name',
      selectedPermissions: []
    }));
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("094a0ba029d318f4")
/******/ })();
/******/ 
/******/ }
);